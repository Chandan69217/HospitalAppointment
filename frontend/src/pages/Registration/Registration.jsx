...
import SelectField from "../../components/Widgets/SelectFields/SelectFields";
    ...
    <div className="register-wrapper">
      <div className="register-container">
        <div className="register-left">
          <img
            src="https://i.postimg.cc/bJyPhbhB/two.jpg"
            alt="Illustration"
          />
        </div>
        ...
        <form className="register-form" onSubmit={handleSubmit}>
          <h2>Let’s Get Started</h2>
          <p className="subtitle">Add your personal details to continue</p>
          ...
          <div className="form-actions">
            <Button type="reset" label={"Reset"} variant="secondary" onClick={handleReset}/>
            {
              loading ? <Loader/>
              :
